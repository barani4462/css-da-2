1.First create a folder my first b
...
3.git commit -m "commit messages" - This wil saveall the file to the local repo
4.git remote add orgin url - This will connect the local repo to the remote repo(Only for the first time)
5.git push -u orgin master - all your local changes will be pushed to the remote repositary
